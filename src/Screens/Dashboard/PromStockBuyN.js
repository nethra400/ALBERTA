...
export default class PromStockBuyN extends React.Component {
    itemArray = [
        {
            label: "Same Item      ",
            value: 0
    ...
    componentDidMount() {
        ...
        // const itemTypeValue = this.props.navigation.getParam("itemTypeValue");
        // this.setState({
        ...
        // if (this.state.itemTypeValue == "Same Item") {
        //     this.state.itemTypeValue = 1;
        // }
                    ...
                    if (data) {
                        ...
                        fetch(
                        ...
                        )}`,
                            {
                                ...
                                body: JSON.stringify({
                                    "promotion_category": "Stock Bound",
                                    sid: sid,
                                    promotion_name: this.state.promotionName,
                                    promotion_code: this.state.promotionCode,
                                    promotion_type: this.state.promotionValue,
