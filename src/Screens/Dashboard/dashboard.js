...
class Dashboard extends React.Component{
  ...
  _renderItem = ({ item }) => {
    return (
      <View >
        <Text style={{color:'white',alignSelf:'center'}}>{item.headerText}</Text>
        {/* <Image source={item.image} /> */}
        <View >
          <Text style={{color:'white',alignSelf:'center'}}>{item.salesText}</Text>
          <Text style={{color:'white',alignSelf:'center',fontSize:20,fontWeight:'bold'}}>{item.salesCount}</Text>
        </View>
    ...
    render() {
        return (
          ...
          onPress={()=>this.handleCancel()}
            ...
            <LinearGradient start={{x: 0, y: 0}} end={{x: 0.8, y: 0.8}} colors={[
                        ...
                        ]} style={{display:'flex',padding:10,height:180,width:'80%',marginLeft:40,marginTop:-100,shadowColor:'#000',shadowOffset:{width:5,height:5},shadowOpacity:0.5,elevation:3}}>
            {/* <View > */}
              {
                 !this.state.showRealApp &&
                 
                  <AppIntroSlider renderItem={this._renderItem} data={this.state.slides}
 ...
 shadowRadius: 5,
            ...
            <View>
             ...
             <TouchableOpacity>
                <ListItem bottomDivider containerStyle={{borderRadius:35,marginHorizontal:10,marginVertical:10}}>
                  <View style={{flexDirection:'row'}}>
                    <FontAwesome name="circle" color={'#3386D6'} size={32} />
                    <Text style={{fontSize:16,paddingVertical:5,paddingHorizontal:16}}>Recieve Order</Text>
                  </View>
                </ListItem>
              </TouchableOpacity>

              <TouchableOpacity>
                <ListItem bottomDivider containerStyle={{borderRadius:35,marginHorizontal:10,marginVertical:5}}>
                  <View style={{flexDirection:'row'}}>
                    <FontAwesome name="circle" color={'#3386D6'} size={32} />
                    <Text style={{fontSize:16,paddingVertical:5,paddingHorizontal:16}}>Print Label</Text>
                  </View>
                </ListItem>
              </TouchableOpacity>
              <TouchableOpacity>
                <ListItem bottomDivider containerStyle={{borderRadius:35,marginHorizontal:10,marginVertical:5}}>
                  <View style={{flexDirection:'row'}}>
                    <FontAwesome name="circle" color={'#3386D6'} size={32} />
                    <Text style={{fontSize:16,paddingVertical:5,paddingHorizontal:16}}>Promotions</Text>
                  </View>
                </ListItem>
              </TouchableOpacity>
              ...
              <TouchableOpacity>
                <ListItem bottomDivider containerStyle={{borderRadius:35,marginHorizontal:10,marginVertical:5}}>
                  <View style={{flexDirection:'row'}}>
                    <FontAwesome name="circle" color={'#3386D6'} size={32} />
                    <Text style={{fontSize:16,paddingVertical:5,paddingHorizontal:16}}>Physical Inventory</Text>
                  </View>
                </ListItem>
              </TouchableOpacity>
              ...
              <TouchableOpacity>
                <ListItem bottomDivider containerStyle={{borderRadius:35,marginHorizontal:10,marginVertical:5}}>
                  <View style={{flexDirection:'row'}}>
                    <FontAwesome name="circle" color={'#3386D6'} size={32} />
                    <Text style={{fontSize:16,paddingVertical:5,paddingHorizontal:16}}>Tutorials</Text>
                  </View>
                </ListItem>
              </TouchableOpacity>
