...
export default class ItemChangePrice extends Component {
          ...
          fetch(API_BASE_URL + `admin/checkPriceBySKU_new?sku=${this.state.barcode}&token=${encodeURIComponent(data)}&sid=${SID}`, {
            ...
            .then((responseJson) => {
              ...
              if (responseJson.status) {
                ...
                var costPrice = responseJson.data[0].dcostprice;
                var QOHData = responseJson.data[0].iqtyonhand;
                var SalesPriceData = responseJson.data[0].dunitprice;
