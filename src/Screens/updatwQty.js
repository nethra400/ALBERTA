...
import {
  ...
  TouchableOpacity, Image, TextInput, AsyncStorage, Vibration, Dimensions, Alert,ImageBackground
} from 'react-native';
...
export default class UpdateQty extends Component {
        ...
        <View style={{width: '100%'}}>
              <ImageBackground
                ...
                <View
                  ...
                  <Text style={{color: 'white'}} onPress={()=>this.props.navigation.navigate('Items')}>Update Quantity</Text>
